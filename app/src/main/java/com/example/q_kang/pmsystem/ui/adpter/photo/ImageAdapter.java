...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    //保存选中的图片
    private ArrayList<ImageItemBean> mSelectImages = new ArrayList<>();
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final ImageItemBean image = mImages.get(position);
    ...
    public ArrayList<ImageItemBean> getData() {
        return mImages;
    }

    public void refresh(ArrayList<ImageItemBean> data) {
        mImages = data;
    ...
    public void setSelectedImages(ArrayList<String> selected) {
        if (mImages != null && selected != null) {
            for (String path : selected) {
                ...
                for (ImageItemBean image : mImages) {
                    if (path.equals(image.getImagePath())) {
                        if (!mSelectImages.contains(image)) {
                            mSelectImages.add(image);
                        }
                        break;
    ...
    public ArrayList<ImageItemBean> getSelectImages() {
