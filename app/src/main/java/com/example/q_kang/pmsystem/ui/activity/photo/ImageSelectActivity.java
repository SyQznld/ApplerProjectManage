...
import com.example.q_kang.pmsystem.modules.bean.bean.photo.Folder;
import com.example.q_kang.pmsystem.modules.bean.bean.photo.ImageItemBean;
import com.example.q_kang.pmsystem.ui.adpter.photo.FolderAdapter;
import com.example.q_kang.pmsystem.ui.adpter.photo.ImageAdapter;
import com.example.q_kang.pmsystem.ui.view.Utils.imageloader.ImageModel;
...
public class ImageSelectActivity extends AppCompatActivity {
    ...
    private void initImageList() {
        ...
        mAdapter.setOnImageSelectListener(new ImageAdapter.OnImageSelectListener() {
            @Override
            public void OnImageSelect(ImageItemBean image, boolean isSelect, int selectCount) {
                setSelectImageCount(selectCount);
            }
        });
        mAdapter.setOnItemClickListener(new ImageAdapter.OnItemClickListener() {
            @Override
            public void OnItemClick(ImageItemBean image, int position) {
    ...
    private void changeTime() {
        ...
        if (firstVisibleItem >= 0 && firstVisibleItem < mAdapter.getData().size()) {
            ImageItemBean image = mAdapter.getData().get(firstVisibleItem);
    ...
    private void confirm() {
        ...
        ArrayList<ImageItemBean> selectImages = mAdapter.getSelectImages();
        ArrayList<String> images = new ArrayList<>();
        for (ImageItemBean image : selectImages) {
    ...
    private void toPreviewActivity(ArrayList<ImageItemBean> images, int position) {
