...
import com.example.q_kang.pmsystem.ui.adpter.photo.ImagePagerAdapter;
import com.example.q_kang.pmsystem.ui.view.Utils.view_.MyViewPager;
...
public class ImagePreviewActivity extends AppCompatActivity {
    ...
    // 用Intent传输发生的错误问题。
    private static ArrayList<ImageItemBean> tempImages;
    private static ArrayList<ImageItemBean> tempSelectImages;

    private ArrayList<ImageItemBean> mImages;
    private ArrayList<ImageItemBean> mSelectImages;
    ...
    public static void openActivity(Activity activity, ArrayList<ImageItemBean> images,
                                    ArrayList<ImageItemBean> selectImages, boolean isSingle,
    ...
    private void initViewPager() {
        ...
        adapter.setOnItemClickListener(new ImagePagerAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position, ImageItemBean image) {
                if (isShowBar) {
                    hideBar();
                } else {
                    showBar();
    ...
    private void clickSelect() {
        ...
        if (mImages != null && mImages.size() > position) {
            ImageItemBean image = mImages.get(position);
    ...
    private void changeSelect(ImageItemBean image) {
