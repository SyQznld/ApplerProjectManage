package com.example.q_kang.pmsystem.JGuang;
...
public class ExampleUtil {
    ...
    public static Set<String> getInPutTags(Context context, String s) {
        // 检查 tag 的有效性
        ...
        for (String sTagItme : sArray) {
            if (!ExampleUtil.isValidTagAndAlias(sTagItme)) {
                Toast.makeText(context, "tag无效格式", Toast.LENGTH_SHORT).show();
                return null;
            }
            tagSet.add(sTagItme);
        }
     ...
     * 获取输入的alias
     */
    public static String getInPutAlias(Context context, String s) {
        if (TextUtils.isEmpty(s)) {
            Toast.makeText(context, "alias不能为空", Toast.LENGTH_SHORT).show();
            return null;
        }
        if (!ExampleUtil.isValidTagAndAlias(s)) {
            Toast.makeText(context, "alias无效格式", Toast.LENGTH_SHORT).show();
            return null;
        }
        return s;
    }
