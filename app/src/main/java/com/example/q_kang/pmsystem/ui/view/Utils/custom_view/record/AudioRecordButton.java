package com.example.q_kang.pmsystem.ui.view.Utils.custom_view.record;
...
//        });
    ...
    public void setListener(AudioFinishRecorderListener listener) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_VOICE_STOP:
                    ...
                    listener.onFinished(mTime, mAudioManager.getCurrentFilePath());
                    Log.i("22222222", "handleMessage: " + mAudioManager.getCurrentFilePath());
                    reset();// 恢复标志位
                    break;
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (!isRecording || mTime < 0.8f) {
                    ...
                    listener = new AudioFinishRecorderListener() {
                        @Override
                        public void onFinished(float seconds, String filePath) {
                            listener.onFinished(mTime, mAudioManager.getCurrentFilePath());
                        }
                    };
                    Log.i("22222222", "handleMessage11:  " + listener);
                    Log.i("22222222", "handleMessage11: " + mAudioManager.getCurrentFilePath());

                    EventBusMessage eventBusMessage = new EventBusMessage("record");
                    eventBusMessage.setRecordPath(mAudioManager.getCurrentFilePath());
                    eventBusMessage.setRecordTime(mTime);
                    EventBus.getDefault().post(eventBusMessage);

//                    EventBus.getDefault().post(new EventBusMessage(mAudioManager.getCurrentFilePath(),mTime));
