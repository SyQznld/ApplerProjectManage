...
import com.example.q_kang.pmsystem.ui.adpter.filter.FilterLeftAdapter;
import com.example.q_kang.pmsystem.ui.adpter.filter.FilterOneAdapter;
import com.example.q_kang.pmsystem.ui.adpter.filter.FilterRightAdapter;
...
public class FilterView extends LinearLayout implements View.OnClickListener {
    ...
    public static final int POSITION_ORG_FILTER = 2; // 筛选的位置
    ...
    public void show(int position) {
        ...
        Log.i(TAG, "setSortAdapter  getCategory: " + filterData.getCategory());
        Log.i(TAG, "setSortAdapter  getSorts: " + filterData.getSorts());
        Log.i(TAG, "setSortAdapter  getOrgFilter: " + filterData.getOrgFilter());
        Log.i(TAG, "setSortAdapter  getFilters: " + filterData.getFilters());
...
//    // 科室筛选视图点击
//    private OnOrgFilterClickListener onFilterOrgClickListener;
//
//    public void setOnFilterClickListener(OnOrgFilterClickListener onFilterOrgClickListener) {
//        this.onFilterOrgClickListener = onFilterOrgClickListener;
//    }
//
//    public interface OnOrgFilterClickListener {
//        void onOrgFilterClick(int position);
//    }
