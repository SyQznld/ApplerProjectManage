package com.example.q_kang.pmsystem.ui.view.Utils.date_time;
...
import com.example.q_kang.pmsystem.ui.view.Utils.date_time.widget.OnWheelChangedListener;
import com.example.q_kang.pmsystem.ui.view.Utils.date_time.widget.OnWheelScrollListener;
import com.example.q_kang.pmsystem.ui.view.Utils.date_time.widget.WheelView;
import com.example.q_kang.pmsystem.ui.view.Utils.date_time.widget.adapters.AbstractWheelTextAdapter;
        ...
        switch (v.getId()) {
            case R.id.sure_btn://确定选择按钮监听
                if (mBlnTimePickerGone) {
                    ...
                    String time = strTimeToDateFormat(mYearStr, mDateStr, mHourStr, mMinuteStr);
                    try {
                        Date parse = new SimpleDateFormat("yyyy-MM-dd HH:mm").parse(time);
                        time = new SimpleDateFormat("yyyy-MM-dd HH:mm").format(parse);
                        dateChooseInterface.getDateTime(time, mBlnBeLongTerm);
